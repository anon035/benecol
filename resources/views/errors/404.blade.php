...
@section('content')
        ...
        <div class="rs-point-table sec-spacer">
            <div class="container">
                <div class="error-404">
                    <span>4<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        width="40px" height="40px" viewBox="0 0 496.013 496.013" style="enable-background:new 0 0 496.013 496.013;"
                        xml:space="preserve">
                    <g>
                        <g>
                            <polygon points="271.942,209.614 338.425,114.466 257.523,39.026 144.542,79.657 148.303,186.135 		"/>
                            <polygon points="228.868,402.407 289.71,465.777 395.984,420.409 413.34,326.511 307.844,313.522 		"/>
                            <path d="M15.731,336.798l1.343,1.644c36.151,92.23,125.889,157.571,230.934,157.571c136.976,0,248.006-111.029,248.006-248.007
                    ...
                    <p>Ľutujeme, požadovaná stránka sa nenašla.</p>                    
                </div>
            </div>
        </div>
